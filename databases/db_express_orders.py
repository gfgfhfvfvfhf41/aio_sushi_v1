...
db = sqlite3.connect("databases/express_orders.db")
cursor = db.cursor()
...
def add_express_order(user_name, product, quantity, delivery_date, created_at):
    cursor.execute(
...
def get_express_orders_by_date(date):
    cursor.execute(
